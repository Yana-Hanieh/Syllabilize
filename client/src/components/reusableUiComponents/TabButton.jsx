function TabButton({label, icon:Icon, isActive, onClick, variant = 'default',disabled = false ,className = ''}){
    const baseStyles = 'w-full flex items-center gap-2 text-left px-4 py-2.5 rounded-full font-medium transition-colors cursor-pointer'; //this is the basic style of the tab buttons
